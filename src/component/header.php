<header class="text-gray-600 body-font bg-slate-700 mb-3">
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
      <a href="index.php" class="mr-5 text-gray-200 hover:text-gray-500">Accueil</a>
      <a href="index.php?theme=variables" class="mr-5 text-gray-200 hover:text-gray-500">Les Variables</a>
      <a href="index.php?theme=conditions" class="mr-5 text-gray-200 hover:text-gray-500">Les Conditions</a>
      <a href="index.php?theme=boucles" class="mr-5 text-gray-200 hover:text-gray-500">Les Boucles</a>
